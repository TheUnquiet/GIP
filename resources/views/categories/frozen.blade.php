...
<div class="holder">
    ...
    <div id="browse" class="mt-3">
        ...
        <div class="container-lg">
            ...
            <div class="container-xl" id="pizza">
                <div class="row">
        ...
        <div class="container-lg">
            ...
            <div class="container-xl" id="iceCream">
                <div class="row">
                    @foreach ($iceCream->products as $item)
                    <div class="card">
                        <img src="{{ $item->image_url }}" class="card-img-top p-2 pt-4" style="object-fit: contain" alt="placeholder">
                        <div class="card-body">
                            <h5 class="card-title" style="color: #ee3966;">{{ $item->category->name }}</h5>
                            <h5 class="card-title">{{ $item->name }}</h5>
                            <p class="card-text">
